...
const ARCHETYPE_DESCRIPTIONS: Record<Lang, string>[] = [
    {
        ...
        pt: 'Vive o esporte pela ação. Sua energia não espera instruções — precisa de movimento constante para estar na zona. Sob pressão, acelera. Quando é freado sem razão, perde a faísca. Desafio permanente e autonomia são seu combustível.',
    },
    {
        ...
        pt: 'Combina a determinação de líder com a capacidade de dosar energia no momento certo. Não é o primeiro a sair, mas também não é o último a chegar. Decide com clareza e age com propósito. Precisa de objetivos claros e espaço para executá-los no seu ritmo.',
    },
    {
    ...
    },
    {
        ...
        pt: 'A equipe é seu habitat natural. Se ativa com o contato, o jogo e a energia coletiva. Reage rápido e fala rápido. Seu entusiasmo contagia o grupo, mas também pode se dispersar se não houver estrutura que o contenha. Precisa de um ambiente dinâmico que não apague sua chama.',
    },
    {
        ...
        pt: 'Constrói pontes com calma e convicção. Se relaciona com todos e sabe quando falar e quando ouvir. Não corre atrás de cada estímulo. Seleciona os momentos para brilhar. Precisa de espaços de reconhecimento genuíno e uma equipe onde sentir que importa.',
    },
    {
        ...
        pt: 'A profundidade não é fraqueza — é seu superpoder silencioso. Conecta com os outros pela escuta e empatia, não pelo barulho. Observa antes de participar, mas quando o faz, deixa marca. Precisa de um ambiente de confiança onde o vínculo seja mais importante que o resultado.',
    },
    {
        ...
        pt: 'Tem o coração da equipe e os pés de um velocista. É o primeiro a estender a mão e também a chegar na bola. Estabiliza o grupo pela ação, não só pelo apoio. Precisa sentir que sua contribuição é visível e que a equipe o reconhece como parte essencial.',
    },
    {
        ...
        pt: 'A coluna vertebral da equipe. Não busca protagonismo, mas sem ele nada funciona. Executa com consistência, apoia sem condições e mantém o ritmo quando os outros falham. Precisa de um ambiente previsível e relações estáveis para dar o melhor de si.',
    },
    {
        ...
        pt: 'A calma no meio da tempestade. Processa cada situação com paciência e age com uma consistência que poucos conseguem manter. Não reage — responde. Precisa de tempo e confiança para se adaptar às mudanças, mas quando o faz, se torna a âncora do grupo.',
    },
    {
        ...
        pt: 'Analisa em segundos o que outros levam minutos para ver. Combina velocidade de processamento com precisão tática — uma raridade que transforma cada jogo em exercício de inteligência aplicada. Precisa de desafios complexos e espaço para liderar pela análise, sem que ninguém interrompa seu processo.',
    },
    {
