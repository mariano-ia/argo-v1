...
const ContentES: React.FC = () => (
    <>
        <Section title="1. Quiénes somos y alcance">
            <p>ArgoMethod® es una herramienta de perfilamiento conductual diseñada para deportistas de 8 a 16 años. Esta política explica qué datos recopilamos, cómo los usamos, cómo los protegemos, y qué derechos tienes sobre ellos.</p>
            <p>Al utilizar ArgoMethod® aceptas esta política. Si no estás de acuerdo, no utilices la Plataforma.</p>
            <p>Si tienes entre 8 y 12 años, no puedes usar ArgoMethod® directamente. Solo puedes participar en la experiencia si un adulto responsable (padre, madre o tutor legal) ha completado el registro y la verificación parental previa.</p>
        </Section>
        ...
        <Section title="4. Consentimiento parental verificable (COPPA)">
            <p>ArgoMethod® cumple con la Children's Online Privacy Protection Act (COPPA) de los Estados Unidos, 15 U.S.C. § 6501 et seq.</p>
        ...
        <Section title="8. Derechos del adulto responsable y del menor">
            <p>Como adulto responsable de un menor perfilado con ArgoMethod®, tienes derecho a:</p>
        ...
        <Section title="11. Contacto">
            ...
            <p>ArgoMethod® no tiene presencia física en Estados Unidos. Para consultas específicas de COPPA, escribe al mismo email con "COPPA" en el asunto y te responderemos dentro de 10 días hábiles.</p>
        </Section>
    </>
);
...
const ContentEN: React.FC = () => (
    <>
        <Section title="1. Who we are and scope">
            <p>ArgoMethod® is a behavioral profiling tool designed for youth athletes aged 8 to 16. This policy explains what data we collect, how we use it, how we protect it, and what rights you have over it.</p>
            <p>By using ArgoMethod®, you accept this policy. If you do not agree, please do not use the Platform.</p>
            <p>If you are between 8 and 12 years old, you cannot use ArgoMethod® directly. You can only participate in the experience if a responsible adult (parent or legal guardian) has completed the registration and parental verification process first.</p>
        </Section>
        ...
        <Section title="4. Verifiable Parental Consent (COPPA)">
            <p>ArgoMethod® complies with the Children's Online Privacy Protection Act (COPPA), 15 U.S.C. § 6501 et seq.</p>
        ...
        <Section title="6. Storage and security">
            <p>Data is stored in Supabase (PostgreSQL). Client-server communication uses HTTPS. Database access is protected by Row Level Security and service keys that are never exposed to the client. ArgoMethod® staff access individual data only when required for technical support or to respond to a user request.</p>
        ...
        <Section title="8. Rights of the responsible adult and the child">
            <p>As the adult responsible for a child profiled with ArgoMethod®, you have the right to:</p>
        ...
        <Section title="11. Contact">
            ...
            <p>ArgoMethod® does not have a physical presence in the United States. For COPPA-specific inquiries, email the same address with "COPPA" in the subject line and we will respond within 10 business days.</p>
        </Section>
    </>
);
...
const ContentPT: React.FC = () => (
    <>
        <Section title="1. Quem somos e escopo">
            <p>ArgoMethod® é uma ferramenta de perfilamento comportamental desenhada para atletas jovens de 8 a 16 anos. Esta política explica quais dados coletamos, como os usamos, como os protegemos e quais direitos você tem sobre eles.</p>
            <p>Ao usar o ArgoMethod® você aceita esta política. Se não concorda, não utilize a Plataforma.</p>
            <p>Se você tem entre 8 e 12 anos, não pode usar o ArgoMethod® diretamente. Só pode participar se um adulto responsável (pai, mãe ou responsável legal) tiver completado o registro e a verificação parental prévia.</p>
        </Section>
        ...
        <Section title="4. Consentimento parental verificável (COPPA)">
            <p>O ArgoMethod® cumpre com a Children's Online Privacy Protection Act (COPPA) dos Estados Unidos, 15 U.S.C. § 6501 et seq.</p>
        ...
        <Section title="6. Armazenamento e segurança">
            <p>Os dados são armazenados no Supabase (PostgreSQL). A comunicação cliente-servidor utiliza HTTPS. O acesso ao banco de dados está protegido por Row Level Security e chaves de serviço que nunca são expostas ao cliente. A equipe do ArgoMethod® só acessa dados individuais quando necessário para suporte técnico ou para responder a uma solicitação do usuário.</p>
        ...
        <Section title="8. Direitos do adulto responsável e do menor">
            <p>Como adulto responsável por um menor perfilado com o ArgoMethod®, você tem direito a:</p>
        ...
        <Section title="11. Contato">
            ...
            <p>O ArgoMethod® não tem presença física nos Estados Unidos. Para consultas específicas de COPPA, escreva ao mesmo email com "COPPA" no assunto e responderemos em até 10 dias úteis.</p>
        </Section>
    </>
);
