...
export const TenantPlayers: React.FC = () => {
    ...
    const playerIntroBody = lang === 'en'
        ? 'Each profile was generated by a completed odyssey. Access the full report of each player.'
        : lang === 'pt'
            ? 'Cada perfil foi gerado por uma odisseia completa. Acesse o relatório completo de cada jogador.'
            : 'Cada perfil fue generado por una odisea completada. Accede al informe completo de cada jugador.';
