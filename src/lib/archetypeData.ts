...
export const ARCHETYPE_DATA: Record<string, ArchetypeData> = {
  ...
  conector_relacional: {
    ...
    palabrasPuente: ["Colaborar", "Nosotros", "Acompañar", "Armonía", "Fluidez", "Confianza"],
  ...
  conector_reflexivo: {
    ...
    checklist: {
      antes: `Llegar con tiempo extra para que pueda ver el ambiente. El caos de llegar tarde tiende a desajustar su ritmo para todo el partido.`,
