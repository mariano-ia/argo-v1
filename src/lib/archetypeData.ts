...
export const ARCHETYPE_DATA: Record<string, ArchetypeData> = {
  impulsor_dinamico: {
    ...
    motorDesc: `El perfil de {nombre} se asocia a un ritmo naturalmente ágil. En la vida cotidiana, esto sugiere que la distancia entre su percepción y su acción tiende a ser muy corta. Para él, aprender probablemente sea experimentar. Es posible que no necesite que le expliquen la teoría del pase en una pizarra durante diez minutos; su manera de procesar la información parece funcionar mejor cuando su cuerpo está en movimiento. Si lo ves inquieto durante las charlas técnicas, es probable que no sea falta de interés ni de respeto, sino su ritmo interno diciendo: "Ya capté la idea, ahora déjame probar el cómo". Invitación de sintonía: Cuando quieras compartirle una indicación, prueba hacerlo mientras él tiene el balón o está en movimiento. La información tiende a "viajar" mejor en su sistema cuando su cuerpo está activo.`,
    ...
    corazon: `Para sintonizar con {nombre}, es valioso aprender a traducir lo que vemos: Lo que puede parecer: Impaciencia o ganas de "querer hacer todo solo". Lo que probablemente es (La Intención): Un deseo profundo de disolver la incertidumbre. Cuando el juego se vuelve caótico, {nombre} tiende a sentir que debe actuar rápido para que el equipo no pierda el rumbo. Su impulso suele ser un acto de cuidado hacia la misión del equipo. El termómetro emocional: Su frustración tiende a expresarse "hacia afuera". Si lo ves con gestos bruscos o aumentando su velocidad de forma errática, es probable que sea una señal de que su sistema se ha sobrecalentado. No es "mal carácter"; es saturación de intensidad.`,
  ...
  impulsor_decidido: {
    ...
    bienvenida: `Este mapa es una invitación a entender cómo {nombre} se conecta con el deporte en esta etapa de su vida. No es una definición de su personalidad para siempre, sino una "fotografía del presente" que nos ayuda a afinar nuestra comunicación con él. Nota de seguridad: Este informe no evalúa el talento. Su único fin es que {nombre} se sienta más comprendido y disfrute más de cada partido, reduciendo la fricción emocional entre sus necesidades y nuestras expectativas.`,
    ...
    ecos: `En casa: {nombre} tiende a ser un niño que agradece saber el "plan del día". Es probable que le guste tener autonomía para resolver sus cosas (deberes, ordenar su cuarto) a su ritmo, siempre que sepa qué se espera de él. En la escuela: Suele ser el alumno que necesita entender el sentido de lo que estudia. Una vez que le ve la utilidad a una materia, su impulso natural tiende a llevarlo a querer destacar en ella.`,
    checklist: {
  ...
  impulsor_persistente: {
    ...
    ecos: `En casa: Es probable que le cueste arrancar las tareas (el "encendido" de su ritmo), pero una vez que se sienta a estudiar, puede estar mucho tiempo concentrado. La clave con él tiende a ser no apurarlo en el inicio, sino valorar lo que logra por persistencia. En la escuela: Suele ser el perfil ideal para proyectos de largo plazo. Puede que no sea el que más participa en clase de forma espontánea, pero es probable que sea el que entregue el trabajo más completo y madurado.`,
    checklist: {
  ...
  conector_vibrante: {
    ...
    bienvenida: `Este mapa es una invitación a mirar el deporte a través de los ojos de {nombre}. No es una sentencia sobre quién es, sino una "fotografía del presente" que nos muestra en qué condiciones tiende a fluir con más alegría. Nota de seguridad: En Método Argo no evaluamos el talento ni diagnosticamos la personalidad. Los niños son dinámicos; este informe simplemente nos ayuda a que el entorno deportivo sea un lugar donde {nombre} se sienta seguro, visto y motivado para seguir jugando.`,
    ...
    ecos: `En casa: Tiende a ser el niño que necesita contarte todo su día nada más entrar por la puerta. Probablemente procesa su vida hablando. Escucharle con atención plena durante 10 minutos suele ser su mejor "recarga" de batería emocional. En la escuela: Tiende a aprender mejor en trabajos grupales. Si tiene que estudiar solo, puede que le ayude "explicarle" la lección a sus muñecos o a ti; es probable que necesite que el conocimiento pase por el canal de la comunicación.`,
    checklist: {
      antes: `El objetivo puede girar en torno a la conexión (ej: "Hoy vamos a enfocarnos en lo bien que animas a tus amigos").`,
      durante: `Dejarlo ser expresivo. No intentar apagar su "música". Si lo ves vibrar, es probable que esté disfrutando.`,
  ...
  conector_relacional: {
    ...
    ecos: `En casa: Tiende a ser un niño que valora mucho los rituales familiares (cenar juntos, un abrazo antes de dormir). Su bienestar probablemente dependa de la calidad de la conexión con sus referentes afectivos. En la escuela: Suele ser el mediador en los conflictos del recreo. Tiende a aprender muy bien a través de la tutoría entre pares (acompañando a otros o recibiendo acompañamiento de un amigo).`,
    checklist: {
  ...
  conector_reflexivo: {
    ...
    wow: `En la tripulación de la Nave Argo, {nombre} tiende a ocupar el lugar de quien detecta las corrientes invisibles. Es probable que sea el tripulante que no necesita gritar para ser escuchado, porque su valor reside en su capacidad para entender lo que el equipo necesita antes de que los demás se den cuenta. Es probable que notes que {nombre} tiende a ser un niño que observa mucho antes de participar plenamente. Su contribución a la tripulación suele ser la cohesión desde la calma. No parece buscar ser el centro de atención, sino el "pegamento silencioso" que hace que todos se sientan parte de algo más grande. Su gran fortaleza tiende a ser la sabiduría social: la capacidad de percibir quién está triste, quién está solo o cuándo el equipo ha perdido la sintonía, aportando una presencia equilibrada que suaviza las tensiones.`,
    motorDesc: `El perfil de {nombre} se asocia a un ritmo naturalmente profundo. En un contexto deportivo que suele exigir velocidad inmediata, es importante entender que su ritmo no sugiere falta de energía, sino riqueza de procesamiento. Mirada cercana: Para él, entrar en el juego puede ser como entrar en una conversación profunda: probablemente necesite escuchar primero para saber qué decir después. Su manera de estar parece escanear el clima emocional y las posiciones antes de activar sus músculos. Si parece pausado al arrancar, es probable que esté integrando toda la información del entorno. Invitación de sintonía: Darle tiempo de "aterrizaje". No lanzarlo a la acción sin previo aviso. Permitirle observar los primeros minutos del entrenamiento puede ayudar a que su ritmo se sincronice con el del grupo.`,
    combustible: `El combustible de {nombre} tiende a ser la aceptación y la pertenencia genuina. Es probable que no le motive ganar por ganar, sino la sensación de que es parte de un grupo donde se le aprecia por quien es. Feedback de sintonía: Tiende a valorar mucho el feedback privado y afectuoso. Un "vi cómo te alegraste por el pase de tu compañero, me gusta que estés atento a ellos" puede ser mucho más potente para él que un aplauso público que lo ponga en el centro de todas las miradas.`,
    grupoEspacio: `En el equipo: Tiende a vincularse a través de la empatía y el tiempo compartido. Suele preferir las conversaciones uno a uno o los grupos pequeños donde el ruido emocional es bajo. Le afectan profundamente las injusticias o los gritos, incluso si no son dirigidos hacia él, porque su sistema tiende a ser un receptor del clima grupal. En el espacio: Suele sentirse cómodo en zonas donde puede tener una visión global. A menudo puede preferir posiciones que le permitan ver todo el campo, ya que eso parece darle la seguridad de entender la "historia" de lo que está pasando en el juego.`,
    ...
    ecos: `En casa: Tiende a ser el niño que necesita "tiempo de descompresión" al llegar de la escuela. Es probable que sea mejor no preguntarle "¿cómo te fue?" nada más entrar; dejar que su ritmo baje y él mismo vendrá a contar las cosas cuando se sienta en sintonía. En la escuela: Suele ser un excelente compañero, alguien que escucha y que prefiere los ambientes de aprendizaje tranquilos. Puede que necesite más tiempo para entregar tareas creativas porque tiende a ponerles mucha carga emocional y detalle.`,
    checklist: {
  ...
  sosten_agil: {
    ...
    guia: [
      ...
      { situacion: "Facilitar un cambio", activador: "Explicar cómo su nueva función es vital para la seguridad de la Nave.", desmotivacion: "Hacer cambios que él perciba como una falta de confianza en su capacidad de acompañamiento." }
    ],
  ...
  sosten_confiable: {
    ...
    ecos: `En casa: Tiende a ser un niño que agradece las rutinas. Saber qué se va a cenar o qué haremos el fin de semana probablemente le dé mucha paz mental. Es probable que sea el hijo en el que "puedes confiar" para que cumpla con sus pequeñas responsabilidades diarias sin tener que recordárselo constantemente. En la escuela: Suele ser un alumno metódico. Le va muy bien en materias que tienen procesos claros y lógica. Puede preferir los exámenes donde sabe exactamente qué temas van a evaluarse antes que las pruebas de "creatividad abierta".`,
    checklist: {
  ...
  sosten_sereno: {
    ...
    wow: `En el mito de los Argonautas, {nombre} tiende a ser ese tripulante que, en medio de la niebla más espesa, permanece sentado en su sitio, manteniendo el ritmo del remo con una paz que tranquiliza a todos los demás. Su naturaleza parece ser la de la estabilidad profunda. Es probable que notes que {nombre} tiende a ser el niño que parece "no sentir la presión". Mientras otros se aceleran o se frustran, él tiende a mantener su expresión y su ritmo. Su contribución a la tripulación suele ser la calma estructural: él tiende a ser el ancla emocional del equipo. Su valor no reside en la velocidad de su ataque, sino en su capacidad para no desordenarse nunca. Su gran fortaleza tiende a ser la imperturbabilidad: ser el lugar seguro al que sus compañeros pueden mirar cuando el partido se vuelve desordenado.`,
    ...
    grupoEspacio: `En el equipo: Tiende a vincularse a través de la lealtad silenciosa. Es probable que sea el compañero que no busca conflictos y que siempre está disponible para un amigo. Su forma de cuidar al grupo suele ser estar presente. Es probable que sea el niño que todos quieren tener cerca cuando las cosas van mal, porque su calma tiende a ser contagiosa. En el espacio: Suele sentirse cómodo en posiciones de retaguardia o de apoyo. Le gusta tener el panorama completo frente a sus ojos. La aglomeración de jugadores puede resultarle estresante; tiende a preferir las zonas donde puede mantener su estructura y su orden técnico sin interferencias.`,
    ...
    ecos: `En casa: Tiende a ser el hijo que aporta paz. No suele ser el que genera conflictos, pero probablemente necesite sus tiempos de silencio. Es probable que valore mucho que no se le apure por la mañana para ir al colegio; tiende a necesitar un despertar suave para que su ritmo empiece a activarse con sintonía. En la escuela: Suele ser el alumno que no se bloquea en los exámenes difíciles. Puede que tarde más en terminar, pero su nivel de precisión tiende a ser alto debido a su procesamiento profundo.`,
    checklist: {
      antes: `Asegurar un ambiente tranquilo. Evitar las prisas y los estímulos excesivamente ruidosos antes de salir de casa.`,
      durante: `Observar su lenguaje corporal. Si lo ves demasiado estático, no pedirle velocidad; invitarlo con un "objetivo de posición" pequeño.`,
  ...
  estratega_reactivo: {
    ...
    guia: [
      ...
      { situacion: "Facilitar un cambio", activador: "Explicar la lógica técnica detrás del cambio de posición o de grupo.", desmotivacion: "Cambios de planes sin una explicación coherente que él pueda procesar." }
    ],
  ...
  estratega_analitico: {
    ...
    corazon: `Para sintonizar con {nombre}, es valioso entender qué hay detrás de su seriedad: Lo que puede parecer: A veces puede dar la impresión de ser un niño algo meticuloso, serio o que elige con cuidado antes de actuar. Lo que probablemente es (La Intención): Un deseo de no fallar al equipo. {nombre} tiende a tomarse el juego con responsabilidad porque siente que su precisión es su forma de ayudar. Su "meticulosidad" suele ser en realidad concentración y respeto por el deporte. El termómetro emocional: Su frustración tiende a ser interna y técnica. Si no logra realizar un movimiento como él sabe que debe hacerse, puede mostrarse muy autocrítico o silencioso. Tiende a temer el desajuste técnico más que el resultado del marcador.`,
    ...
    guia: [
      ...
      { situacion: "Acompañar su confianza", activador: "Validar la calidad de su proceso: \"Vi cómo pensaste la jugada, la lógica era perfecta\".", desmotivacion: "Señalamientos genéricos o comparaciones con niños que juegan de forma más impulsiva." },
    ...
    ecos: `En casa: Tiende a ser el hijo que prefiere saber el "por qué" de los acuerdos. Es probable que valore mucho que seas coherente y que los planes se cumplan. Le gusta tener su espacio y sus materiales ordenados a su manera. En la escuela: Suele ser un alumno muy cumplidor que disfruta de las materias con procesos claros (matemáticas, gramática, música). Tiende a necesitar saber qué se espera exactamente de él en un examen para no sentirse ansioso.`,
    checklist: {
      ...
      durante: `Evitar las indicaciones constantes. Confiar en su capacidad de auto-ajuste; probablemente él ya sepa cuándo algo no salió técnicamente bien.`,
  ...
  estratega_observador: {
    ...
    corazon: `Para sintonizar con {nombre}, es valioso traducir su silencio: Lo que puede parecer: A veces puede dar la impresión de estar distraído, tímido o que "le falta intensidad" ante la dinámica del partido. Lo que probablemente es (La Intención): Un deseo de actuar con lógica. {nombre} tiende a preferir no actuar de forma desordenada o por puro impulso. Su pausa suele ser un acto de respeto por la eficiencia. Para él, moverse sin sentido probablemente sea peor que no moverse. El termómetro emocional: Su frustración puede presentarse como una "pausa prolongada de análisis". Si el juego se vuelve demasiado desordenado o impredecible, puede retraerse y dejar de participar porque su mente no encuentra un patrón que seguir.`,
    ...
    ecos: `En casa: Tiende a ser un hijo que necesita entender el "por qué" de las cosas. Es probable que no acepte un "porque sí". Suele valorar mucho los juegos de estrategia, los puzzles o cualquier actividad que requiera pensar un plan. En la escuela: Puede ser ese alumno que parece estar en su mundo, pero que cuando le preguntas, tiene la respuesta más profunda. Le tienden a encantar las ciencias, el ajedrez o la lectura, donde puede sumergirse en sistemas lógicos.`,
    checklist: {
...
export const TENDENCIA_CONTENT: Record<string, TendenciaContent> = {
  ...
  D_C: {
    parrafo: `La acción de {nombre} tiende a no ser impulsiva: detrás de su rapidez probablemente haya un proceso de análisis que ocurre en fracciones de segundo. Esta combinación sugiere un perfil que actúa con precisión quirúrgica. Es probable que le interese no solo hacer las cosas rápido, sino hacerlas bien. Puede frustrarse si siente que la velocidad del juego le impide ejecutar con la calidad que él visualiza internamente. Reconocer la inteligencia detrás de sus decisiones rápidas tiende a ser la forma más efectiva de nutrir su confianza.`,
