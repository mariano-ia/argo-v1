...
export const ARCHETYPE_DATA: Record<string, ArchetypeData> = {
  impulsor_dinamico: {
    ...
    perfilExtended: `Tiende a moverse antes de que la mayoría termine de procesar la situación. Tiende a necesitar sentir que sus acciones producen un impacto visible para mantenerse motivado y conectado. En los momentos de mayor inercia del equipo, suele ser quien activa el movimiento.`,
  ...
  impulsor_decidido: {
    ...
    eje: `D`,
    motor: `Medio`,
    label: `Impulsor Rítmico`,
    perfil: `Iniciativa Estratégica y Ejecución con Propósito`,
    perfilExtended: `Tiende a combinar el impulso de actuar con la claridad de saber hacia dónde va. Tiende a tomar la iniciativa cuando el objetivo está definido, con una fuerza y enfoque que convierten la intención en resultados tangibles. Su fortaleza suele estar en la consistencia de la ejecución, no en la impulsividad.`,
    ...
    guia: [
      { situacion: "Sostener su conexión", activador: "Ofrecer un objetivo técnico que invite a usar su potencia y decisión.", desmotivacion: "Cambiar las reglas del juego a mitad de la actividad sin aviso." },
  ...
  impulsor_persistente: {
    ...
    eje: `D`,
    motor: `Lento`,
    label: `Impulsor Sereno`,
    perfil: `Determinación Constante y Resiliencia en el Esfuerzo`,
    perfilExtended: `Su fuerza tiende a no estar en la velocidad sino en la permanencia. Tiende a sostener el esfuerzo cuando otros se detienen, con una determinación que crece cuanto más difícil se pone el camino. El equipo puede contar con su voluntad en los momentos que exigen aguante más que velocidad.`,
  ...
  conector_vibrante: {
    ...
    eje: `I`,
    motor: `Rápido`,
    label: `Conector Dinámico`,
    perfil: `Entusiasmo Contagioso y Cohesión a través de la Energía`,
    perfilExtended: `Su presencia suele activar el entorno de manera casi inmediata. Tiende a ser quien eleva el ánimo del grupo cuando la energía decae, celebrando el logro de un compañero con más fuerza que el propio. Su aporte más valioso suele ser el clima emocional que crea a su alrededor.`,
  ...
  conector_relacional: {
    ...
    perfilExtended: `Suele saber cuándo animar y cuándo escuchar, y esa lectura tiende a hacerla de forma intuitiva. Su habilidad para leer el estado de ánimo de sus compañeros tiende a convertirlo en el puente entre los perfiles más intensos y los más reservados. Su presencia aporta calma y cohesión sin quitarle alegría al grupo.`,
  ...
  conector_reflexivo: {
    ...
    perfilExtended: `Tiende a percibir el estado emocional del equipo con una sensibilidad poco frecuente. Tiende a ser el pegamento silencioso que hace que todos se sientan parte de algo más grande, sin necesitar ser el centro de atención. Su fortaleza suele estar en la sabiduría social: tiende a detectar cuándo alguien necesita apoyo antes de que el resto se dé cuenta.`,
    ...
    motorDesc: `El perfil de {nombre} se asocia a un ritmo naturalmente profundo. En un contexto deportivo que suele exigir velocidad inmediata, es importante entender que su ritmo no sugiere falta de energía, sino riqueza de procesamiento. Mirada cercana: Entrar en el juego puede ser como entrar en una conversación profunda: probablemente necesite escuchar primero para saber qué decir después. Su manera de estar parece escanear el clima emocional y las posiciones antes de activar sus músculos. Si parece pausado al arrancar, es probable que esté integrando toda la información del entorno. Invitación de sintonía: Darle tiempo de "aterrizaje". No lanzarlo a la acción sin previo aviso. Permitirle observar los primeros minutos de la actividad puede ayudar a que su ritmo se sincronice con el del grupo.`,
    ...
    checklist: {
      antes: `Llegar con tiempo extra para que pueda ver el ambiente. El caos de llegar tarde tiende a desajustar su ritmo de Conector Sereno para todo el partido.`,
  ...
  sosten_agil: {
    ...
    eje: `S`,
    motor: `Rápido`,
    label: `Sostenedor Dinámico`,
    perfil: `Reacción de Auxilio Veloz y Apoyo Dinámico`,
    perfilExtended: `Suele tener un radar especial para detectar cuándo un compañero necesita ayuda o cuándo queda un espacio vacío en el campo. Combina la disposición natural a acompañar con un ritmo de respuesta ágil, actuando antes de que se lo pidan. Su presencia aporta seguridad reactiva sin frenar el movimiento del equipo.`,
  ...
  sosten_confiable: {
    ...
    eje: `S`,
    motor: `Medio`,
    label: `Sostenedor Rítmico`,
    perfil: `Consistencia Serena y Apoyo Estructurado`,
    perfilExtended: `Su mayor fortaleza suele ser la previsibilidad positiva: el equipo suele poder contar con que estará donde tiene que estar. Tiende a mantener la calma y el orden cuando otros empiezan a perder los nervios, siendo la base estable del grupo. No busca los focos, pero su ausencia se sentiría de inmediato.`,
  ...
  sosten_sereno: {
    ...
    eje: `S`,
    motor: `Lento`,
    label: `Sostenedor Sereno`,
    perfil: `Resistencia Imperturbable y Calma Estructural`,
    perfilExtended: `Tiende a mantener la calma cuando la presión aumenta, transmitiendo una estabilidad que ordena a quienes lo rodean. Su ritmo profundo no se trata de lentitud: suele ser su manera de sostener al equipo cuando el partido se vuelve desordenado. Su mejor versión suele aparecer cuando el cansancio empieza a afectar a los demás.`,
  ...
  estratega_reactivo: {
    ...
    eje: `C`,
    motor: `Rápido`,
    label: `Estratega Dinámico`,
    perfil: `Precisión Instantánea y Ajuste Táctico Veloz`,
    perfilExtended: `Tiende a leer el juego con rapidez y a actuar sobre lo que analiza sin demora. Tiende a detectar cuándo un compañero está mal ubicado o cuándo un acuerdo no se está cumpliendo, antes de que los demás lo noten. Su combinación de análisis e inmediatez tiende a convertirlo en el ojo del entrenador dentro del campo.`,
    ...
    guia: [
      { situacion: "Sostener su conexión", activador: "Ofrecer una \"misión de ajuste\" (ej: \"Ayúdanos a que la defensa mantenga la línea\").", desmotivacion: "Consignas ambiguas o actividades basadas solo en el azar." },
  ...
  estratega_analitico: {
    ...
    eje: `C`,
    motor: `Medio`,
    label: `Estratega Rítmico`,
    perfil: `Procesamiento Técnico y Ejecución con Propósito`,
    perfilExtended: `Suele procesar la información antes de activar la respuesta, lo que le da una precisión en la ejecución que destaca dentro del equipo. Tiende a necesitar entender el sentido de lo que hace, y una vez que lo entiende, aplica el plan con una fidelidad que aporta orden colectivo. Su fortaleza tiende a estar en la calidad de sus decisiones, no en la velocidad.`,
    ...
    guia: [
      { situacion: "Sostener su conexión", activador: "Proponerle retos de precisión (ej: \"Hoy el objetivo es que 4 de cada 5 pases lleguen al destino\").", desmotivacion: "Actividades desordenadas o basadas solo en el contacto físico sin táctica." },
  ...
  estratega_observador: {
    ...
    perfilExtended: `Tiende a procesar la información con una profundidad poco común, analizando posiciones, espacios y patrones antes de actuar. Tiende a observar el partido incluso mientras juega, con una claridad estratégica que tiende a convertirlo en el ancla inteligente del equipo. Lo que puede parecer lentitud suele ser rigor: cuando decide, lo hace desde una comprensión muy completa de la situación.`,
...
export const TENDENCIA_CONTENT: Record<string, TendenciaContent> = {
  ...
  S_C: {
    parrafo: `La estabilidad de {nombre} tiende a tener una base técnica sólida. Es probable que su constancia no sea solo emocional sino también metódica: le gusta hacer las cosas de la misma manera porque ha encontrado un sistema que funciona. Esta combinación sugiere un perfil de "ancla técnica": el compañero que suele estar en su posición, que ejecuta su rutina con muy pocos tropiezos y que da tranquilidad al grupo con su previsibilidad. Si se le pide cambiar su método, es importante explicarle el porqué técnico, no solo el porqué emocional.`,
