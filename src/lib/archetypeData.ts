...
export const ARCHETYPE_DATA: Record<string, ArchetypeData> = {
  impulsor_dinamico: {
    ...
    perfilExtended: `Se mueve antes de que la mayoría termina de procesar la situación. Tiende a necesitar sentir que sus acciones producen un impacto visible para mantenerse motivado y conectado. En los momentos de mayor inercia del equipo, suele ser quien activa el movimiento.`,
  ...
  impulsor_decidido: {
    ...
    perfilExtended: `Combina el impulso de actuar con la claridad de saber hacia dónde va. Tiende a tomar la iniciativa cuando el objetivo está definido, con una fuerza y enfoque que convierten la intención en resultados tangibles. Su fortaleza está en la consistencia de la ejecución, no en la impulsividad.`,
  ...
  impulsor_persistente: {
    ...
    perfilExtended: `Su fuerza no es la velocidad sino la permanencia. Tiende a sostener el esfuerzo cuando otros se detienen, con una determinación que crece cuanto más difícil se pone el camino. El equipo puede contar con su voluntad en los momentos que exigen aguante más que velocidad.`,
  ...
  conector_vibrante: {
    ...
    perfilExtended: `Su presencia activa el entorno de manera casi inmediata. Tiende a ser quien eleva el ánimo del grupo cuando la energía decae, celebrando el logro de un compañero con más fuerza que el propio. Su aporte más valioso suele ser el clima emocional que crea a su alrededor.`,
  ...
  conector_relacional: {
    ...
    perfilExtended: `Sabe cuándo animar y cuándo escuchar, y esa lectura tiende a hacerla de forma intuitiva. Su habilidad para leer el estado de ánimo de sus compañeros lo convierte en el puente entre los perfiles más intensos y los más reservados. Su presencia aporta calma y cohesión sin quitarle alegría al grupo.`,
  ...
  conector_reflexivo: {
    ...
    perfilExtended: `Percibe el estado emocional del equipo con una sensibilidad poco frecuente. Tiende a ser el pegamento silencioso que hace que todos se sientan parte de algo más grande, sin necesitar ser el centro de atención. Su fortaleza está en la sabiduría social: detecta cuándo alguien necesita apoyo antes de que el resto se dé cuenta.`,
  ...
  sosten_confiable: {
    ...
    perfilExtended: `Su mayor fortaleza es la previsibilidad positiva: el equipo puede contar con que siempre estará donde tiene que estar. Tiende a mantener la calma y el orden cuando otros empiezan a perder los nervios, siendo la base estable del grupo. No busca los focos, pero su ausencia se sentiría de inmediato.`,
  ...
  sosten_sereno: {
    ...
    perfilExtended: `Tiende a mantener la calma cuando la presión aumenta, transmitiendo una estabilidad que ordena a quienes lo rodean. Su ritmo profundo no es lentitud: es su manera de ser el ancla emocional del equipo cuando el partido se vuelve desordenado. Su mejor versión suele aparecer cuando el cansancio empieza a afectar a los demás.`,
  ...
  estratega_reactivo: {
    ...
    perfilExtended: `Lee el juego con rapidez y actúa sobre lo que analiza sin demora. Tiende a detectar cuándo un compañero está mal ubicado o cuándo un acuerdo no se está cumpliendo, antes de que los demás lo noten. Su combinación de análisis e inmediatez lo convierte en el ojo del entrenador dentro del campo.`,
  ...
  estratega_analitico: {
    ...
    perfilExtended: `Procesa la información antes de activar la respuesta, lo que le da una precisión en la ejecución que destaca dentro del equipo. Tiende a necesitar entender el sentido de lo que hace, y una vez que lo entiende, aplica el plan con una fidelidad que aporta orden colectivo. Su fortaleza está en la calidad de sus decisiones, no en la velocidad.`,
  ...
  estratega_observador: {
    ...
    perfilExtended: `Procesa la información con una profundidad poco común, analizando posiciones, espacios y patrones antes de actuar. Tiende a observar el partido incluso mientras juega, con una claridad estratégica que lo convierte en el ancla inteligente del equipo. Lo que puede parecer lentitud suele ser rigor: cuando decide, lo hace desde una comprensión muy completa de la situación.`,
