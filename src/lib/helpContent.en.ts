...
export const HELP_ARTICLES_EN: HelpArticle[] = [
    ...
    },
    {
        ...
        steps: [
            ...
            'Assign a coach or share the link yourself.',
        ],
        audience: 'admin',
    ...
    },
    {
        ...
        body: 'Coaches are invited from Users. When you invite them as a coach, you choose which teams they are assigned to. Each one will see only the players in their teams.',
        steps: [
            'Open Users.',
            'Tap Invite and enter the coach email.',
            'Choose the Coach role and check their teams.',
