...
export const SITUATION_CARDS_EN: SituationCard[] = [
    ...
    },
    {
        ...
        eje: "D",
        whatsHappeningForProfile: "The Driver experiences the bench as a loss of control and of their place in the spotlight. Sitting still while others play weighs heavily on them, and that tension usually comes out as frustration or impatience.",
    ...
    },
    {
        situationId: "acepta-ser-suplente",
        eje: "I",
        whatsHappeningForProfile: "The Connector fears that being on the bench means they let someone down or that they're no longer part of the group. More than the role, it hurts to feel left out of the bond.",
    ...
    },
    {
        situationId: "acepta-ser-suplente",
        eje: "C",
        whatsHappeningForProfile: "The Strategist needs to understand why they're on the bench. If the criteria aren't clear, they turn it over and over and can conclude on their own that they did something wrong or that they're not good enough.",
    ...
    },
    {
        ...
        eje: "D",
        whatsHappeningForProfile: "The Driver experiences the teammate's achievement as a competition they are losing. Their instinct is to prove right away that they can do it too, and if they cannot find a way, they get frustrated.",
    ...
    },
    {
        situationId: "companero-se-destaca",
        eje: "I",
        whatsHappeningForProfile: "The Connector feels the group's affection and attention went to someone else, and they take it to mean they are liked less. The social displacement hurts more than the result.",
    ...
    },
    {
        situationId: "companero-se-destaca",
        eje: "S",
        whatsHappeningForProfile: "The Supporter keeps the discomfort to themselves and steps into the background without saying a word. On the outside it looks like it doesn't affect them, but the irritation keeps building and can surface later all at once.",
    ...
    },
    {
        situationId: "companero-se-destaca",
        eje: "C",
        whatsHappeningForProfile: "The Strategist stays stuck analyzing why the other did it better and compares themselves point by point. That internal tally makes them incredibly hard on themselves.",
    ...
    },
    {
        ...
        eje: "D",
        whatsHappeningForProfile: "The Driver confuses a correction with losing ground. They need to feel that they are still capable and that they have room to improve on their own, not that they were left looking bad.",
    ...
    },
    {
        situationId: "recibe-correccion",
        eje: "I",
        whatsHappeningForProfile: "The Connector feels the correction as a blow to the relationship, not to the technique. They care more about whether they let you down or got exposed than about the detail you pointed out.",
    ...
    },
    {
        situationId: "recibe-correccion",
        eje: "S",
        whatsHappeningForProfile: "The Supporter nods and seems to take it well, but inside they hold on to the discomfort. They avoid friction in the moment and the unease shows up later, more quietly.",
    ...
    },
    {
        situationId: "recibe-correccion",
        eje: "C",
        whatsHappeningForProfile: "The Strategist understands the correction, but gets stuck on the detail and becomes very demanding with themselves. They find it hard to let go of what happened and keep playing.",
    ...
    },
    {
        ...
        eje: "D",
        whatsHappeningForProfile: "The Driver feels success with a lot of intensity and needs to show it. Once they feel like a winner, their effort engine eases off because they believe the challenge is over.",
    ...
    },
    {
        situationId: "gestiona-exito",
        eje: "I",
        whatsHappeningForProfile: "The Connector experiences success through others and gets excited when they feel the group celebrating. Carried away by that emotion, they can unintentionally take over the moment and leave the rest of the team out.",
    ...
    },
    {
        situationId: "gestiona-exito",
        eje: "C",
        whatsHappeningForProfile: "The Strategist analyzes their good performance and can convince themselves that they have already figured it all out. Sensing there is nothing left to improve, they let their guard down without realizing it.",
    ...
    },
    {
        situationId: "rol-referente",
        eje: "I",
        whatsHappeningForProfile: "The Connector leads naturally through connection, but it weighs on them when the role means setting a limit or deciding between friends. They don't want to let anyone down.",
    ...
    },
    {
        situationId: "rol-referente",
        eje: "C",
        whatsHappeningForProfile: "The Strategist hesitates because they're still not clear on what's expected of them, and they'd rather wait than carry out the role halfway. The idea of getting it wrong in front of everyone weighs on them.",
    ...
    },
    {
        ...
        eje: "D",
        whatsHappeningForProfile: "The Driver turns the expectation into pressure to win no matter what. When they feel the result decides whether or not they let their parents down, they overdemand from themselves and react with intense frustration to any mistake.",
    ...
    },
    {
        situationId: "expectativa-padres",
        eje: "I",
        whatsHappeningForProfile: "The Connector needs to feel their parents' pride in order to play freely. A serious face from the outside disconnects them right away, because for them performing well and being loved are linked together.",
    ...
    },
    {
        situationId: "expectativa-padres",
        eje: "S",
        whatsHappeningForProfile: "The Supporter keeps the tension inside and does not show it. They keep playing quietly, but more rigidly, and the weight builds up until it surfaces all at once at a bad moment.",
    ...
    },
    {
        situationId: "expectativa-padres",
        eje: "C",
        whatsHappeningForProfile: "The Strategist gets stuck inside their head trying to figure out what is expected of them. They demand twice as much from themselves and end up playing tight out of fear of not living up to what they believe the adults want to see.",
    ...
    },
    {
        ...
        eje: "D",
        whatsHappeningForProfile: "The Driver used to be a reference point and now they are the newcomer among the older players. Losing that spotlight touches their confidence, and they may cover it up with anger or by competing too hard to win back ground.",
    ...
    },
    {
        situationId: "sube-categoria",
        eje: "I",
        whatsHappeningForProfile: "The Connector left their usual group behind and has not yet found their place among the new ones. Even surrounded by teammates, they feel left out, and that drains their motivation more than any matter of play.",
    ...
    },
    {
        situationId: "sube-categoria",
        eje: "S",
        whatsHappeningForProfile: "The Supporter gets destabilized by the change of routine, schedule and familiar faces. They pull back into the background and carry the discomfort in silence, until one day it all weighs on them at once.",
    ...
    },
    {
        situationId: "sube-categoria",
        eje: "C",
        whatsHappeningForProfile: "The Strategist is reading the whole new setting: the pace, the group's unspoken rules, where they fit in. While they process, they can seem switched off or hesitate before playing, because they do not yet fully understand how this category works.",
