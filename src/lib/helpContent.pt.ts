...
export const HELP_ARTICLES_PT: HelpArticle[] = [
    ...
    },
    {
        ...
        steps: [
            ...
            'Atribua um treinador ou compartilhe você mesmo o link.',
        ],
        audience: 'admin',
    ...
    },
    {
        ...
        body: 'Os treinadores são convidados em Usuários. Ao convidá-los como treinador, você escolhe a quais plantéis eles ficam atribuídos. Cada um verá apenas os jogadores dos seus plantéis.',
        steps: [
            'Abra Usuários.',
            'Toque em Convidar e digite o email do treinador.',
            'Escolha o papel Treinador e marque os plantéis dele.',
