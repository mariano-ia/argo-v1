...
const es: DashboardTexts = {
    ...
    groups: {
        titulo: 'Química de grupos',
        subtitulo: 'Crea grupos, comparte su enlace y asigna entrenadores. Cada grupo tiene su química propia.',
        ...
        sinGruposDesc: 'Crea tu primer grupo para empezar a organizar a tus jugadores.',
...
const en: DashboardTexts = {
    ...
    groups: {
        titulo: 'Group chemistry',
        subtitulo: 'Create groups, share their link and assign coaches. Each group has its own chemistry.',
        crearGrupo: 'Create group',
        nombrePlaceholder: 'Group name (e.g.: U-15 Girls)',
        tusGrupos: 'Your groups',
        sinGrupos: 'No groups created yet.',
        sinGruposDesc: 'Create your first group to start organizing your players.',
...
const pt: DashboardTexts = {
    ...
    groups: {
        titulo: 'Química de grupos',
        subtitulo: 'Crie grupos, compartilhe o link e atribua treinadores. Cada grupo tem sua própria química.',
        ...
        sinGruposDesc: 'Crie seu primeiro grupo para começar a organizar seus jogadores.',
