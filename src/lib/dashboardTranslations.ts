...
const es: DashboardTexts = {
    ...
    groups: {
        titulo: 'Equipos',
        subtitulo: 'Crea equipos, comparte su enlace y asigna entrenadores. Cada equipo tiene su química propia.',
        crearGrupo: 'Crear equipo',
        nombrePlaceholder: 'Nombre del equipo (ej: Sub-15 Femenino)',
        tusGrupos: 'Tus equipos',
        sinGrupos: 'No tienes equipos creados todavía.',
        sinGruposDesc: 'Crea tu primer equipo para empezar a organizar a tus jugadores.',
...
const en: DashboardTexts = {
    ...
    groups: {
        titulo: 'Teams',
        subtitulo: 'Create teams, share their link and assign coaches. Each team has its own chemistry.',
...
const pt: DashboardTexts = {
    ...
    groups: {
        titulo: 'Equipes',
        subtitulo: 'Crie equipes, compartilhe o link e atribua treinadores. Cada equipe tem sua própria química.',
        crearGrupo: 'Criar equipe',
        nombrePlaceholder: 'Nome da equipe (ex: Sub-15 Feminino)',
        tusGrupos: 'Suas equipes',
        sinGrupos: 'Nenhuma equipe criada ainda.',
        sinGruposDesc: 'Crie sua primeira equipe para começar a organizar seus jogadores.',
