...
const es: DashboardTexts = {
    ...
    players: {
        ...
        brujulaSecundaria: 'Veta secundaria',
        guiaRapida: 'Guía rápida',
        activar: 'Activar',
        aConsiderar: 'A considerar',
        checklistEntrenamiento: 'Checklist del día',
        antes: 'Antes',
        durante: 'Durante',
        despues: 'Después',
    ...
    groups: {
        ...
        sinGrupos: 'No tienes planteles creados todavía.',
        sinGruposDesc: 'Crea tu primer plantel para empezar a organizar a tus jugadores.',
        agregarJugadores: 'Agregar jugadores',
        sinMiembros: 'Este plantel no tiene jugadores todavía.',
        sinMiembrosDesc: 'Agrega jugadores desde tus sesiones completadas.',
        eliminarGrupo: 'Eliminar plantel',
        confirmarEliminar: '¿Eliminar este plantel permanentemente?',
        grupoCreado: 'Plantel creado',
        grupoRenombrado: 'Plantel renombrado',
        grupoEliminado: 'Plantel eliminado',
        jugadorQuitado: 'Jugador quitado del plantel',
        ...
        todosEnGrupo: 'Todos tus jugadores ya están en este plantel.',
    ...
    chat: {
        ...
        consultaDISC: 'Consulta sobre Argo',
        consultaDesc: 'Pregunta lo que necesites sobre tus jugadores, el equipo, o situaciones de la actividad (entrenamientos, partidos, competencias).',
        escribePlaceholder: 'Escribe tu consulta...',
        disclaimer: 'Argo Coach puede cometer errores. Las respuestas son orientativas y están basadas en la metodología Argo. No reemplazan el criterio profesional.',
    ...
    groupBalance: {
        ...
        diversidadDISC: 'Diversidad de estilos',
        perfilMotorGrupo: 'Perfil de motor del grupo',
        distribucionDISC: 'Distribución de estilos',
        ...
        secFortalezas: 'Lo que mejor hace este equipo',
        secHerramientas: 'Cómo acompañar a este equipo',
        secDistribucion: 'Cómo está compuesto el grupo',
        secIndicadores: 'Equilibrio del grupo',
        secMotor: 'Ritmo de procesamiento',
        secDuplas: 'Duplas que se potencian',
...
const en: DashboardTexts = {
    ...
    players: {
        ...
        brujulaSecundaria: 'Secondary lean',
        guiaRapida: 'Quick guide',
        activar: 'Activate',
        aConsiderar: 'To consider',
        checklistEntrenamiento: 'Daily checklist',
        antes: 'Before',
        durante: 'During',
        despues: 'After',
    ...
    groups: {
        ...
        sinGrupos: 'No teams created yet.',
        sinGruposDesc: 'Create your first team to start organizing your players.',
        agregarJugadores: 'Add players',
        sinMiembros: 'This team has no players yet.',
        sinMiembrosDesc: 'Add players from your completed sessions.',
        eliminarGrupo: 'Delete team',
        confirmarEliminar: 'Delete this team permanently?',
        grupoCreado: 'Team created',
        grupoRenombrado: 'Team renamed',
        grupoEliminado: 'Team deleted',
        jugadorQuitado: 'Player removed from team',
        jugadoresAgregados: (n) => `${n} ${n === 1 ? 'player added' : 'players added'}`,
        sinJugadoresDisponibles: 'No players available to add.',
        todosEnGrupo: 'All your players are already in this team.',
    ...
    chat: {
        ...
        consultaDISC: 'Argo consultation',
        consultaDesc: 'Ask anything about your players, the team, or any activity situation (training, matches, competitions).',
        escribePlaceholder: 'Write your question...',
        disclaimer: 'Argo Coach may make mistakes. Responses are guidance-based on the Argo methodology. They do not replace professional judgment.',
    ...
    groupBalance: {
        ...
        diversidadDISC: 'Style diversity',
        perfilMotorGrupo: 'Group motor profile',
        distribucionDISC: 'Style distribution',
        ...
        secFortalezas: 'What this team does best',
        secHerramientas: 'How to support this team',
        secDistribucion: 'Group composition',
        secIndicadores: 'Group balance',
        secMotor: 'Processing pace',
        secDuplas: 'Pairs that boost each other',
...
const pt: DashboardTexts = {
    ...
    players: {
        ...
        brujulaSecundaria: 'Veta secundária',
        guiaRapida: 'Guia rápido',
        activar: 'Ativar',
        aConsiderar: 'A considerar',
        checklistEntrenamiento: 'Checklist do dia',
        antes: 'Antes',
        durante: 'Durante',
        despues: 'Depois',
    ...
    groups: {
        ...
        sinGrupos: 'Nenhum plantel criado ainda.',
        sinGruposDesc: 'Crie seu primeiro plantel para começar a organizar seus jogadores.',
        agregarJugadores: 'Adicionar jogadores',
        sinMiembros: 'Este plantel ainda não tem jogadores.',
        sinMiembrosDesc: 'Adicione jogadores das suas sessões concluídas.',
        eliminarGrupo: 'Excluir plantel',
        confirmarEliminar: 'Excluir este plantel permanentemente?',
        grupoCreado: 'Plantel criado',
        grupoRenombrado: 'Plantel renomeado',
        grupoEliminado: 'Plantel excluído',
        jugadorQuitado: 'Jogador removido do plantel',
        ...
        todosEnGrupo: 'Todos os seus jogadores já estão neste plantel.',
    ...
    chat: {
        ...
        consultaDISC: 'Consulta Argo',
        consultaDesc: 'Pergunte o que precisar sobre seus jogadores, a equipe ou situações da atividade (treinos, jogos, competições).',
        escribePlaceholder: 'Escreva sua pergunta...',
        disclaimer: 'Argo Coach pode cometer erros. As respostas são orientativas e baseadas na metodologia Argo. Não substituem o critério profissional.',
    ...
    groupBalance: {
        ...
        secFortalezas: 'O que este time faz de melhor',
        secHerramientas: 'Como acompanhar este time',
        secDistribucion: 'Composição do grupo',
        secIndicadores: 'Equilíbrio do grupo',
        secMotor: 'Ritmo de processamento',
        secDuplas: 'Duplas que se potencializam',
        secSimulador: 'E se...?',
