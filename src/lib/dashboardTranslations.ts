...
const es: DashboardTexts = {
    ...
    chat: {
        ...
        disclaimer: 'Argo Engine puede cometer errores. Las respuestas son orientativas y están basadas en la metodologia Argo. No reemplazan el criterio profesional.',
...
const en: DashboardTexts = {
    ...
    chat: {
        ...
        disclaimer: 'Argo Engine may make mistakes. Responses are guidance-based on the Argo methodology. They do not replace professional judgment.',
...
const pt: DashboardTexts = {
    ...
    chat: {
        ...
        disclaimer: 'Argo Engine pode cometer erros. As respostas são orientativas e baseadas na metodologia Argo. Não substituem o critério profissional.',
