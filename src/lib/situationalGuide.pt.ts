...
export const SITUATION_CARDS_PT: SituationCard[] = [
    ...
    },
    {
        ...
        eje: "D",
        whatsHappeningForProfile: "O Impulsionador vive o banco como uma perda de controle e do seu lugar de protagonista. Ficar parado enquanto outros jogam pesa muito para ele, e essa tensão costuma sair como irritação ou impaciência.",
    ...
    },
    {
        situationId: "acepta-ser-suplente",
        eje: "I",
        whatsHappeningForProfile: "O Conector teme que estar no banco signifique que decepcionou ou que já não faz parte do grupo. Mais do que o papel, dói nele sentir-se fora do vínculo.",
    ...
    },
    {
        situationId: "acepta-ser-suplente",
        eje: "C",
        whatsHappeningForProfile: "O Estrategista precisa entender por que está no banco. Se não tem claro o critério, fica remoendo e pode concluir sozinho que fez algo errado ou que não é bom o bastante.",
    ...
    },
    {
        ...
        eje: "D",
        whatsHappeningForProfile: "O Impulsionador vive a conquista do colega como uma competição que está perdendo. Seu instinto é mostrar na hora que ele também pode, e se não encontra como, se frustra.",
    ...
    },
    {
        situationId: "companero-se-destaca",
        eje: "I",
        whatsHappeningForProfile: "O Conector sente que o carinho e a atenção do grupo foram para outro, e vive isso como se gostassem menos dele. Dói mais o deslocamento social do que o resultado.",
    ...
    },
    {
        situationId: "companero-se-destaca",
        eje: "S",
        whatsHappeningForProfile: "O Sustentador guarda o incômodo e se afasta para o segundo plano sem dizer nada. Por fora parece que não o afeta, mas a irritação vai se acumulando e pode aparecer mais tarde de uma vez.",
    ...
    },
    {
        situationId: "companero-se-destaca",
        eje: "C",
        whatsHappeningForProfile: "O Estrategista fica analisando por que o outro fez melhor e se compara ponto por ponto. Essa conta interna o torna duríssimo consigo mesmo.",
    ...
    },
    {
        ...
        eje: "D",
        whatsHappeningForProfile: "O Impulsionador confunde a correção com perder terreno. Ele precisa sentir que continua sendo capaz e que tem margem para melhorar por conta própria, não que o deixaram em má posição.",
    ...
    },
    {
        situationId: "recibe-correccion",
        eje: "I",
        whatsHappeningForProfile: "O Conector sente a correção como um golpe no vínculo, não na técnica. Importa mais para ele se decepcionou você ou se ficou exposto do que o detalhe que você apontou.",
    ...
    },
    {
        situationId: "recibe-correccion",
        eje: "S",
        whatsHappeningForProfile: "O Sustentador concorda e parece levar numa boa, mas por dentro guarda o incômodo. Evita o atrito na hora e o desconforto aparece depois, de um jeito mais calado.",
    ...
    },
    {
        situationId: "recibe-correccion",
        eje: "C",
        whatsHappeningForProfile: "O Estrategista entende a correção, mas fica preso no detalhe e se torna muito exigente consigo mesmo. Tem dificuldade para soltar o que aconteceu e voltar a jogar.",
    ...
    },
    {
        ...
        eje: "D",
        whatsHappeningForProfile: "O Impulsionador sente o sucesso com muita intensidade e precisa mostrá-lo. Quando já se sente vencedor, seu motor de esforço afrouxa porque acredita que o desafio terminou.",
    ...
    },
    {
        situationId: "gestiona-exito",
        eje: "I",
        whatsHappeningForProfile: "O Conector vive o sucesso através dos outros e se entusiasma quando sente a comemoração do grupo. Levado por essa emoção, sem querer pode monopolizar o momento e deixar o resto do time de fora.",
    ...
    },
    {
        situationId: "gestiona-exito",
        eje: "C",
        whatsHappeningForProfile: "O Estrategista analisa seu bom rendimento e pode se convencer de que já entendeu tudo. Ao sentir que não tem mais nada a melhorar, baixa a guarda sem perceber.",
    ...
    },
    {
        situationId: "rol-referente",
        eje: "I",
        whatsHappeningForProfile: "O Conector lidera com naturalidade a partir do vínculo, mas pesa quando o papel implica colocar um limite ou decidir entre amigos. Ele não quer decepcionar ninguém.",
    ...
    },
    {
        situationId: "rol-referente",
        eje: "C",
        whatsHappeningForProfile: "O Estrategista hesita porque ainda não tem clareza do que se espera dele, e prefere esperar a exercer o papel pela metade. Pesa para ele a ideia de errar na frente de todos.",
    ...
    },
    {
        ...
        eje: "D",
        whatsHappeningForProfile: "O Impulsionador transforma a expectativa em uma pressão por ganhar de qualquer jeito. Quando sente que o resultado define se decepcionou ou não os pais, se exige demais e reage com frustração intensa diante de qualquer erro.",
    ...
    },
    {
        situationId: "expectativa-padres",
        eje: "I",
        whatsHappeningForProfile: "O Conector precisa sentir o orgulho dos pais para jogar leve. Uma cara séria lá de fora o desconecta na hora, porque para ele render bem e ser amado estão unidos.",
    ...
    },
    {
        situationId: "expectativa-padres",
        eje: "S",
        whatsHappeningForProfile: "O Sustentador guarda a tensão por dentro e não a mostra. Segue jogando calado, mas mais rígido, e a carga vai se acumulando até aparecer de repente em um momento ruim.",
    ...
    },
    {
        situationId: "expectativa-padres",
        eje: "C",
        whatsHappeningForProfile: "O Estrategista se enfia na própria cabeça tentando decifrar o que esperam dele. Se autoexige o dobro e acaba jogando travado por medo de não estar à altura do que acredita que os adultos querem ver.",
    ...
    },
    {
        ...
        eje: "D",
        whatsHappeningForProfile: "O Impulsionador vinha sendo uma referência e agora é o novato entre os mais velhos. Perder esse lugar de protagonismo mexe com a confiança dele, e ele pode esconder isso com raiva ou competindo demais para recuperar terreno.",
    ...
    },
    {
        situationId: "sube-categoria",
        eje: "I",
        whatsHappeningForProfile: "O Conector deixou para trás o seu grupo de sempre e ainda não encontrou o seu lugar entre os novos. Mesmo cercado de colegas, ele se sente de fora, e isso reduz a vontade dele mais do que qualquer questão de jogo.",
    ...
    },
    {
        situationId: "sube-categoria",
        eje: "S",
        whatsHappeningForProfile: "O Sustentador se desestabiliza com a mudança de rotina, de horários e de rostos conhecidos. Recua para o segundo plano e sustenta o incômodo em silêncio, até que um dia tudo pesa de uma vez.",
    ...
    },
    {
        situationId: "sube-categoria",
        eje: "C",
        whatsHappeningForProfile: "O Estrategista está lendo todo o cenário novo: o ritmo, os códigos do grupo, onde ele se encaixa. Enquanto processa pode parecer apagado ou hesitar antes de jogar, porque ainda não entende totalmente como funciona esta categoria.",
