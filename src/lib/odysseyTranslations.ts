...
const es: OdysseyTranslations = {
    ...
    consentCheck: (name) => `Soy mayor de 18 años y el padre, madre o tutor legal de ${name || 'este deportista'}, y acepto la Política de Privacidad y los Términos.`,
    ...
    reportSections: {
        ...
        beforeTraining: 'Antes',
        duringTraining: 'Durante',
...
const en: OdysseyTranslations = {
    ...
    consentCheck: (name) => `I am over 18 and the parent or legal guardian of ${name || 'this athlete'}, and I accept the Privacy Policy and Terms of Service.`,
    ...
    reportSections: {
        ...
        beforeTraining: 'Before',
        duringTraining: 'During',
        afterTraining: 'After',
    },
...
const pt: OdysseyTranslations = {
    ...
    consentCheck: (name) => `Tenho mais de 18 anos e sou o pai, mãe ou responsável legal por ${name || 'este atleta'}, e aceito a Política de Privacidade e os Termos.`,
