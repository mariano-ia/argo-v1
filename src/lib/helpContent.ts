...
export const HELP_ARTICLES: HelpArticle[] = [
    ...
    },
    {
        ...
        steps: [
            ...
            'Asigna un entrenador o comparte tú mismo el link.',
        ],
        audience: 'admin',
    ...
    },
    {
        ...
        body: 'Los entrenadores se invitan desde Usuarios. Al invitarlos como entrenador, eliges a qué planteles quedan asignados. Cada uno verá solo a los jugadores de sus planteles.',
        steps: [
            'Entra a Usuarios.',
            'Toca Invitar y escribe el email del entrenador.',
            'Elige el rol Entrenador y marca sus planteles.',
