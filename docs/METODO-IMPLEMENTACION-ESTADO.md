...
| **2A** | Migración aditiva `20260706_perfilamiento_ficha.sql` (**escrita, NO aplicada**) + `question_id`/`QUESTION_VERSION`/`SIGNATURE_SCENES` aditivos | `203907c` | tsc 0 errores |
