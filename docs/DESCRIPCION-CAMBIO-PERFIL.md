...
potencial asoma, cerrando con una **acción concreta** para acompañar. Va como una línea gris discreta a la
derecha/debajo de la entrada "actual" del timeline.
...
(Sin "ahora es", "mejoró/empeoró", "cambio notable", talento, ganar, errores, etiquetas. Cálido, probabilístico,
...
- **Corrimiento por eje** `Δ[e] = v_nuevo[e] − v_viejo[e]`; `argmax Δ` = "lo que creció".
...
(se usa el nombre en la acción, no "lo/la", para evitar género).

### 5.1 Plantillas según S
| Caso | es | en | pt |
|---|---|---|---|
| Estable (S≥0.85) | "{N} se mantiene fiel a su esencia, con [FORTALEZA]. [ACCIÓN_MANTENER]." | "{N} stays true to their essence, with [STRENGTH]. [KEEP_ACTION]." | "{N} se mantém fiel à sua essência, com [FORÇA]. [AÇÃO_MANTER]." |
| Moderado (0.6–0.85) | "{N} sigue con su esencia de siempre, y empieza a asomar un poco más de [RASGO]: un lindo potencial para acompañar. [ACCIÓN_EMERGENTE]." | "{N} keeps their usual essence, and a bit more [TRAIT] is starting to show: a lovely potential to nurture. [EMERGING_ACTION]." | "{N} segue com a sua essência de sempre, e começa a despontar um pouco mais de [TRAÇO]: um belo potencial para acompanhar. [AÇÃO_EMERGENTE]." |
| Mayor (S<0.6) | "En estos meses {N} fue mostrando una faceta nueva, con más [RASGO]: un potencial valioso para nutrir. [ACCIÓN_EMERGENTE]." | "Over these months {N} has shown a new facet, with more [TRAIT]: a valuable potential to nurture. [EMERGING_ACTION]." | "Nestes meses {N} foi mostrando uma faceta nova, com mais [TRAÇO]: um potencial valioso para nutrir. [AÇÃO_EMERGENTE]." |

### 5.2 Por eje — RASGO que asoma + ACCIÓN_EMERGENTE
...
| S Sostenedor | constancia para sostener al equipo / steadiness to support the team / constância para apoiar o time | "Puedes confiarle a {N} una tarea estable donde su constancia se note." / "You can entrust {N} with a steady task where that consistency stands out." / "Você pode confiar a {N} uma tarefa estável onde essa constância apareça." |
...
### 5.4 Cláusula de motor (solo si el motor cambió)
| Cambio | es / en / pt |
|---|---|
| Más rápido | "Además, ahora responde de forma más inmediata." / "Also, {N} now responds more immediately." / "Além disso, agora {N} responde de forma mais imediata." |
| Más pausado | "Además, ahora se toma un poco más de tiempo para decidir, y eso le da más calidad a sus jugadas." / "Also, {N} now takes a bit more time to decide, which adds quality to their play." / "Além disso, agora {N} leva um pouco mais de tempo para decidir, o que dá mais qualidade às suas jogadas." |
| Igual | (no se agrega nada) |

### 5.5 Ejemplo armado (Olivia: moderado, asoma D, motor igual)
- es: "Olivia sigue con su esencia de siempre, y empieza a asomar un poco más de iniciativa: un lindo potencial para acompañar. Puedes invitar a Olivia a proponer una jugada o a liderar un ejercicio corto."
- en: "Olivia keeps her usual essence, and a bit more initiative is starting to show: a lovely potential to nurture. You can invite Olivia to suggest a play or lead a short drill."
- pt: "Olivia segue com a sua essência de sempre, e começa a despontar um pouco mais de iniciativa: um belo potencial para acompanhar. Você pode convidar Olivia a propor uma jogada ou liderar um exercício curto."

### 5.6 Variedad — que NO se repita la misma frase entre niños
Hoy el riesgo: dos niños en la misma situación (mismo caso+eje+motor) dirían lo mismo, y pegados en la lista se ve
robótico. Solución:
...
- **Garantía anti-adyacente:** al renderizar la lista, si la frase de un niño coincide con la del de arriba, se salta
  a la siguiente variante. Determinístico. Nunca dos pegados idénticos.
- Aperturas (es, ejemplo): "sigue con su esencia de siempre, y empieza a asomar..." / "mantiene su forma de ser de
  siempre, y se va sumando..." / "conserva su sello de siempre, y se nota que empieza a crecer en...". (Evitan género.)
- Acciones (es, eje D, ejemplo): "Puedes invitar a {N} a proponer una jugada..." / "Una idea: darle a {N} la
  oportunidad de dirigir un momento del entrenamiento."
...
- Re-perfilar un niño de prueba y ver la frase correcta en su timeline, en los 3 idiomas, sin repetir con el de arriba.
