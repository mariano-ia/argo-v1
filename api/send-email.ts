...
function buildHtml(params: {
    ...
    const copy = {
        es: {
            ...
            ctaSub: 'El informe completo incluye patrón de decisión, guía de comunicación, checklist para la actividad, brújula secundaria y más.',
        ...
        en: {
            ...
            ctaSub: 'The full report includes decision pattern, communication guide, activity checklist, secondary compass, and more.',
        ...
        pt: {
            ...
            ctaSub: 'O relatório completo inclui padrão de decisão, guia de comunicação, checklist para a atividade, bússola secundária e mais.',
