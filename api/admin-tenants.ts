                ...
                try {
                    const emailRes = await fetch('https://api.resend.com/emails', {
                        ...
                        body: JSON.stringify({
                            ...
                            to: [email],
                            subject: entLang === 'en' ? `Welcome to ArgoMethod® Enterprise, ${display_name}` : entLang === 'pt' ? `Bem-vindo ao ArgoMethod® Enterprise, ${display_name}` : `Bienvenido a ArgoMethod® Enterprise, ${display_name}`,
